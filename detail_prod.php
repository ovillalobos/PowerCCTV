...
<head>	
	<?php 	
	if ( $showPage == "yes" ){
		$fa_link = "http://powercctv.com/detail_prod.php?pack=".$_GET["pack"];
...
<?php include( "include/protectHTML.php" );?>
	...
	***************************************************************************************************************/?>
	...
	<div class="container marginUp10">
		...
		<div class="col-lg-12 marginUp10 brdIncludeDesktop">
			...
			<div class="col-lg-2 marginUp10 padding10 borderBoRes bordeRightGray">
				...
				switch($resoMP){
					...
					case "7.0 MP": echo '<img src="images/icon/megapixel_7.0.png" class="img70por" >'; break;
			...
			<div class="col-lg-2 marginUp10 padding10 borderBoRes bordeRightGray">
				...
				switch($resoMP){
					...
					case "7.0 MP": echo '<img src="images/icon/hd_4000.png" class="img70por" >'; break;
		...
		/*************************************************************************************************************************************/
		if( $perFeatures == "si" ){
			echo '<div class="col-lg-12 marginUp10 animationRight"><hr/><table width="100%" ><tr><td align="left" ><p class="titleProd2">Main Features</p></td><td align="right" ><img src="images/icon/menu_icon.png" class="iconMidMenu" ></td></tr></table><hr/></div>';
			echo '<div class="col-lg-12 marginUp10 animationRight"><div class="col-md-12">';
			for($i=1;$i<=$numPerFea;$i++){ echo '<img class="animationRight" src="images/depro/cam/bg/cam_'.$numPackGen.'.fe'.$i.'.png" width="100%" ><br/><br/>'; }
			echo '</div></div>';
		}
		if( $indoor == "si" ){
