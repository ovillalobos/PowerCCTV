...
a.gallerySlider&&(this.galleryOptions=d.extend(this.galleryOptions,a.gallerySlider));this.$elem.append('<div class="is-mobile"></div>');"inside"==this.options.miniSliderArrowPos&&this.$elem.addClass("in");2==this.options.miniSliderArrowStyle&&this.$elem.addClass("as2");if(1==this.options.showMediumImg){var c=this.$elem.find("img:nth-of-type(1)").data("medium-img");this.$elem.prepend('<div class="eagle-medium-wrap"><a class="eagle-view-medium-img"><img src="'+c+'" alt=""></a><div class="scale-ico"></div></div>');
this.$medium=this.$elem.find(".eagle-medium-wrap");this.global.showMediumImg=!0}else this.global.showMediumImg=!1,!1!==this.options.autoPlayMediumImg&&(this.miniOptions.autoPlay=this.options.autoPlayMediumImg,this.miniOptions.stopOnHover=!0,this.miniOptions.rewindNav=!0,this.options.autoPlayMediumImg=!1);!1!==this.options.autoPlayMediumImg&&(this.miniOptions.autoPlay=!1);this.$elem.find(".owl-carousel").owlCarouselE(this.miniOptions);this.miniSlider=this.$elem.find(".owl-carousel").data("owlCarouselE");
1==this.options.showMediumImg&&this.showMediumImg();this.openGallery()},showMediumImg:function(){var a=this;a.$elem.on("click",".owl-carousel."+a.miniOptions.theme+" .owl-item img",function(b){b.preventDefault();0==a.global.isNoDrag&&a.changeMediumImg(d(this),!1)});!0===a.options.autoPlayMediumImg&&(a.options.autoPlayMediumImg=5E3);!1!==a.options.autoPlayMediumImg&&(!1!==a.options.changeMediumStyle&&a.options.autoPlayMediumImg<a.options.changeMediumSpeed&&(a.options.autoPlayMediumImg=a.options.changeMediumSpeed),
k.clearInterval(a.autoPlayMediumInterval),a.playMedium(),"ontouchstart"in k||k.navigator.msMaxTouchPoints?a.stopMediumOnTouch():a.stopMediumOnHover())},playMedium:function(){var a=this,b=a.$elem.find(".owl-carousel."+a.miniOptions.theme+" .owl-item").length,c,h,d;k.clearInterval(a.autoPlayMediumInterval);a.autoPlayMediumInterval=k.setInterval(function(){c=a.$elem.find(".owl-carousel."+a.miniOptions.theme+" .owl-item.active").index()+1;d=c+1;d>b&&(d=1);h=a.$elem.find(".owl-carousel."+a.miniOptions.theme+
" .owl-item:nth-of-type("+d+") img");a.changeMediumImg(h,!0)},a.options.autoPlayMediumImg)},stopMedium:function(){k.clearInterval(this.autoPlayMediumInterval)},stopMediumOnHover:function(){var a=this;a.$elem.on("mouseover",function(){a.stopMedium()});a.$elem.on("mouseout",function(){a.playMedium()})},stopMediumOnTouch:function(){var a=this;a.$elem.on("touchstart",function(){a.stopMedium();d(p).on("touchend",function(){a.playMedium()})})},changeMediumImg:function(a,b){var c=this,h={slideIn:function(a,
b){a>b&&c.$medium.addClass("slideInNext");a<b&&c.$medium.addClass("slideInPrev")},slideOut:function(a,b){a>b&&c.$medium.addClass("slideOutNext");a<b&&c.$medium.addClass("slideOutPrev")},scaleIn:function(){c.$medium.addClass("scaleIn")},scaleOut:function(){c.$medium.addClass("scaleOut")}},f=a.data("medium-img"),g=d("<img>",{src:f}),e=a.parent().index(),q=c.$elem.find(".owl-item.active").index();if(e!=q){var l=setTimeout(function(){c.$medium.append('<div class="loading">Loading...</div>')},500);g.load(function(){clearTimeout(l);
c.$medium.find(".loading").length&&c.$medium.find(".loading").remove();if(0==c.options.changeMediumStyle)c.$elem.find(".eagle-view-medium-img img").attr("src",f),b&&c.miniSlider.goTo(e);else{iterations=0;if(1==c.options.changeMediumStyle){var a=1+Math.floor(4*Math.random());1==a&&h.slideIn(e,q);2==a&&h.slideOut(e,q);3==a&&h.scaleIn();4==a&&h.scaleOut()}"slideIn"==c.options.changeMediumStyle&&h.slideIn(e,q);"slideOut"==c.options.changeMediumStyle&&h.slideOut(e,q);"scaleIn"==c.options.changeMediumStyle&&
...
!0===this.options.autoPlay&&(this.options.autoPlay=5E3);this.play();this.$elem.find(".owl-wrapper").css("display","block");this.$elem.is(":visible")?this.$elem.css("opacity",1):this.watchVisibility();this.onstartup=!1;this.eachMoveUpdate();"function"===typeof this.options.afterInit&&this.options.afterInit.apply(this,[this.$elem]);this.options.galleryslider||this.$elem.find(".owl-item:first-child").addClass("active");1==f.global.showMediumImg&&this.$elem.addClass("ih")},eachMoveUpdate:function(){!0===
this.options.lazyLoad&&this.lazyLoad();!0===this.options.autoHeight&&this.autoHeight();this.onVisibleItems();"function"===typeof this.options.afterAction&&this.options.afterAction.apply(this,[this.$elem])},updateVars:function(){"function"===typeof this.options.beforeUpdate&&this.options.beforeUpdate.apply(this,[this.$elem]);this.watchVisibility();this.updateItems();this.calculateAll();this.updatePosition();this.updateControls();this.eachMoveUpdate();"function"===typeof this.options.afterUpdate&&this.options.afterUpdate.apply(this,
...
this.$elem.find(".owl-wrapper").wrap('<div class="owl-wrapper-outer">');this.wrapperOuter=this.$elem.find(".owl-wrapper-outer");this.$elem.css("display","block")},baseClass:function(){var a=this.$elem.hasClass(this.options.baseClass),b=this.$elem.hasClass(this.options.theme);a||this.$elem.addClass(this.options.baseClass);b||this.$elem.addClass(this.options.theme)},updateItems:function(){var a,b;if(!1===this.options.responsive)return!1;if(!0===this.options.singleItem)return this.options.items=this.orignalItems=
1,this.options.itemsCustom=!1,this.options.itemsDesktop=!1,this.options.itemsDesktopSmall=!1,this.options.itemsTablet=!1,this.options.itemsTabletSmall=!1,this.options.itemsMobile=!1;a=this.$elem.closest(d(this.options.responsiveBaseWidth)).width();a>(this.options.itemsDesktop[0]||this.orignalItems)&&(this.options.items=this.orignalItems);if(!1!==this.options.itemsCustom)for(this.options.itemsCustom.sort(function(a,b){return a[0]-b[0]}),b=0;b<this.options.itemsCustom.length;b+=1)this.options.itemsCustom[b][0]<=
a&&(this.options.items=this.options.itemsCustom[b][1]);else a<=this.options.itemsDesktop[0]&&!1!==this.options.itemsDesktop&&(this.options.items=this.options.itemsDesktop[1]),a<=this.options.itemsDesktopSmall[0]&&!1!==this.options.itemsDesktopSmall&&(this.options.items=this.options.itemsDesktopSmall[1]),a<=this.options.itemsTablet[0]&&!1!==this.options.itemsTablet&&(this.options.items=this.options.itemsTablet[1]),a<=this.options.itemsTabletSmall[0]&&!1!==this.options.itemsTabletSmall&&(this.options.items=
this.options.itemsTabletSmall[1]),a<=this.options.itemsMobile[0]&&!1!==this.options.itemsMobile&&(this.options.items=this.options.itemsMobile[1]);this.options.items>this.itemsAmount&&!0===this.options.itemsScaleUp&&(this.options.items=this.itemsAmount)},response:function(){var a=this,b,c;if(!0!==a.options.responsive)return!1;c=d(k).width();a.resizer=function(){d(k).width()!==c&&(!1!==a.options.autoPlay&&k.clearInterval(a.autoPlayInterval),k.clearTimeout(b),b=k.setTimeout(function(){c=d(k).width();
a.updateVars()},a.options.responsiveRefreshRate))};d(k).resize(a.resizer)},updatePosition:function(){this.jumpTo(this.currentItem);!1!==this.options.autoPlay&&this.checkAp()},appendItemsSizes:function(){var a=this,b=0,c=a.itemsAmount-a.options.items;a.$owlItems.each(function(h){var f=d(this);f.css({width:a.itemWidth}).data("owl-item",Number(h));if(0===h%a.options.items||h===c)h>c||(b+=1);f.data("owl-roundPages",b)})},appendWrapperSizes:function(){this.$owlWrapper.css({width:this.$owlItems.length*
...
loops:function(){var a=0,b=0,c,h;this.positionsInArray=[0];this.pagesInArray=[];for(c=0;c<this.itemsAmount;c+=1)b+=this.itemWidth,this.positionsInArray.push(-b),!0===this.options.scrollPerPage&&(h=d(this.$owlItems[c]),h=h.data("owl-roundPages"),h!==a&&(this.pagesInArray[a]=this.positionsInArray[c],a=h))},buildControls:function(){if(!0===this.options.navigation||!0===this.options.pagination)this.owlControls=d('<div class="owl-controls"/>').toggleClass("clickable",!this.browser.isTouch).appendTo(this.$elem);
!0===this.options.pagination&&this.buildPagination();!0===this.options.navigation&&this.buildButtons()},buildButtons:function(){var a=this,b=d('<div class="owl-buttons"/>');a.owlControls.append(b);a.buttonPrev=d("<div/>",{"class":"owl-prev",html:a.options.navigationText[0]||""});a.buttonNext=d("<div/>",{"class":"owl-next",html:a.options.navigationText[1]||""});b.append(a.buttonPrev).append(a.buttonNext);b.on("touchstart.owlControls mousedown.owlControls",'div[class^="owl"]',function(a){a.preventDefault()});
b.on("touchend.owlControls mouseup.owlControls",'div[class^="owl"]',function(b){b.preventDefault();d(this).hasClass("owl-next")?a.next():a.prev()})},buildPagination:function(){var a=this;a.paginationWrapper=d('<div class="owl-pagination"/>');a.owlControls.append(a.paginationWrapper);a.paginationWrapper.on("touchend.owlControls mouseup.owlControls",".owl-page",function(b){b.preventDefault();Number(d(this).data("owl-page"))!==a.currentItem&&a.goTo(Number(d(this).data("owl-page")),!0)})},updatePagination:function(){var a,
b,c,h,f,g;if(!1===this.options.pagination)return!1;this.paginationWrapper.html("");a=0;b=this.itemsAmount-this.itemsAmount%this.options.items;for(h=0;h<this.itemsAmount;h+=1)0===h%this.options.items&&(a+=1,b===h&&(c=this.itemsAmount-this.options.items),f=d("<div/>",{"class":"owl-page"}),g=d("<span></span>",{text:!0===this.options.paginationNumbers?a:"","class":!0===this.options.paginationNumbers?"owl-numbers":""}),f.append(g),f.data("owl-page",b===h?c:h),f.data("owl-roundPages",a),this.paginationWrapper.append(f));
this.checkPagination()},checkPagination:function(){var a=this;if(!1===a.options.pagination)return!1;a.paginationWrapper.find(".owl-page").each(function(){d(this).data("owl-roundPages")===d(a.$owlItems[a.currentItem]).data("owl-roundPages")&&(a.paginationWrapper.find(".owl-page").removeClass("active"),d(this).addClass("active"))})},checkNavigation:function(){if(!1===this.options.navigation)return!1;!1===this.options.rewindNav&&(0===this.currentItem&&0===this.maximumItem?(this.buttonPrev.addClass("disabled"),
this.buttonNext.addClass("disabled")):0===this.currentItem&&0!==this.maximumItem?(this.buttonPrev.addClass("disabled"),this.buttonNext.removeClass("disabled")):this.currentItem===this.maximumItem?(this.buttonPrev.removeClass("disabled"),this.buttonNext.addClass("disabled")):0!==this.currentItem&&this.currentItem!==this.maximumItem&&(this.buttonPrev.removeClass("disabled"),this.buttonNext.removeClass("disabled")))},updateControls:function(){this.updatePagination();this.checkNavigation();this.owlControls&&
(this.options.items>=this.itemsAmount?this.owlControls.hide():this.owlControls.show())},destroyControls:function(){this.owlControls&&this.owlControls.remove()},next:function(a){if(this.isTransition)return!1;this.currentItem+=!0===this.options.scrollPerPage?this.options.items:1;if(this.currentItem>this.maximumItem+(!0===this.options.scrollPerPage?this.options.items-1:0))if(!0===this.options.rewindNav)this.currentItem=0,a="rewind";else return this.currentItem=this.maximumItem,!1;this.goTo(this.currentItem,
...
[d.$elem]);a>=d.maximumItem?a=d.maximumItem:0>=a&&(a=0);d.currentItem=d.owl.currentItem=a;if(!1!==d.options.transitionStyle&&"drag"!==c&&1===d.options.items&&!0===d.browser.support3d)return d.swapSpeed(0),!0===d.browser.support3d?d.transition3d(d.positionsInArray[a]):d.css2slide(d.positionsInArray[a],1),d.afterGo(),d.singleItemTransition(),!1;a=d.positionsInArray[a];!0===d.browser.support3d?(d.isCss3Finish=!1,!0===b?(d.swapSpeed("paginationSpeed"),k.setTimeout(function(){d.isCss3Finish=!0},d.options.paginationSpeed)):
"rewind"===b?(d.swapSpeed(d.options.rewindSpeed),k.setTimeout(function(){d.isCss3Finish=!0},d.options.rewindSpeed)):(d.swapSpeed("slideSpeed"),k.setTimeout(function(){d.isCss3Finish=!0},d.options.slideSpeed)),d.transition3d(a)):!0===b?d.css2slide(a,d.options.paginationSpeed):"rewind"===b?d.css2slide(a,d.options.rewindSpeed):d.css2slide(a,d.options.slideSpeed);d.afterGo()},jumpTo:function(a){"function"===typeof this.options.beforeMove&&this.options.beforeMove.apply(this,[this.$elem]);a>=this.maximumItem||
-1===a?a=this.maximumItem:0>=a&&(a=0);this.swapSpeed(0);!0===this.browser.support3d?this.transition3d(this.positionsInArray[a]):this.css2slide(this.positionsInArray[a],1);this.currentItem=this.owl.currentItem=a;this.afterGo()},afterGo:function(){var a=this;a.prevArr.push(a.currentItem);a.prevItem=a.owl.prevItem=a.prevArr[a.prevArr.length-2];a.prevArr.shift(0);if(a.prevItem!==a.currentItem&&(a.checkPagination(),a.checkNavigation(),a.eachMoveUpdate(),!1!==a.options.autoPlay&&a.checkAp(),a.options.galleryslider)){var b=
a.$elem.find(".owl-item.active").index()+1;a.$elem.closest(".eagle-open-gallery").find(".ea-current").html(b);1==b?a.$elem.closest(".eagle-open-gallery").find(".eagle-prev").addClass("disabled"):b==a.$elem.find(".owl-item").length?a.$elem.closest(".eagle-open-gallery").find(".eagle-next").addClass("disabled"):a.$elem.closest(".eagle-open-gallery").find(".eagle-next, .eagle-prev").removeClass("disabled");setTimeout(function(){a.$owlItems.find(".eagle-item").removeAttr("style");f.global.open.find(".top-controls").hasClass("ea-hide")||
...
afterInit:!1,beforeMove:!1,afterMove:!1,afterAction:!1,startDragging:!1,afterLazyLoad:!1,galleryslider:!1}})(jQuery,window,document);